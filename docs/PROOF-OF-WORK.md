...
| Railway deployment | Initial production deployment from commit `18e84a5` succeeded with Node 22.23.2; anonymous product and social-image requests returned HTTP 200 | [Heirloom on Railway](https://heirloom-protocol-production.up.railway.app) |
